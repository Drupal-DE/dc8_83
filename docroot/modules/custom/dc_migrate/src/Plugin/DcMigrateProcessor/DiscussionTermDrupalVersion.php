...
/**
 * Process class to attach the drupal version to discussion nodes.
 *
 * @DcMigrateProcessor(
 *   id = "discussion_fields__drupal_version",
 *   description = "Set drupal version on discussion nodes",
 *   weight = 1
 * )
 */
class DiscussionTermDrupalVersion extends DiscussionTerm {
  ...
  public function init() {
    parent::init();
    $this->sourceDataTableName = 'dcmigrate_source__node__discussion_dv';
  }
  ...
  protected function getSourceQuery() {
    ...
    $expression = "CASE
		WHEN tn.tid = 25 THEN 'term--version-46'
		WHEN tn.tid = 26 THEN 'term--version-47'
		WHEN tn.tid = 245 THEN 'term--version-47'
		WHEN tn.tid = 31 THEN 'term--version-5'
		WHEN tn.tid = 389 THEN 'term--version-5'
		WHEN tn.tid = 87 THEN 'term--version-6'
		WHEN tn.tid = 1517 THEN 'term--version-6'
		WHEN tn.tid = 1122 THEN 'term--version-7'
		WHEN tn.tid = 1518 THEN 'term--version-7'
		WHEN tn.tid = 1519 THEN 'term--version-8'
		WHEN tn.tid = 1520 THEN 'term--version-8'
	END";
